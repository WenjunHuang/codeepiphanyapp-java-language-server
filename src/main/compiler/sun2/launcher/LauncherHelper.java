...
import jdk2.internal.misc.VM;
import jdk2.internal.module.ModuleBootstrap;
import jdk2.internal.module.Modules;
import jdk2.internal.platform.Container;
import jdk2.internal.platform.Metrics;
import sun2.util.calendar.ZoneInfoFile;
...
public final class LauncherHelper {
    ...
    private static final String JAVAFX_FXHELPER_CLASS_NAME_SUFFIX =
            "sun2.launcher.LauncherHelper$FXHelper";
    ...
    // sync with java.c and jdk2.internal.misc.VM
    private static final String diagprop = "sun2.java.launcher.diag";
    static final boolean trace = VM.getSavedProperty(diagprop) != null;

    private static final String defaultBundleName =
            "sun2.launcher.resources.launcher";
        ...
        try (JarFile jarFile = new JarFile(jarname)) {
            ...
            if (agentClass != null) {
                ModuleLayer.boot().findModule("java.instrument").ifPresent(m -> {
                    try {
                        String cn = "sun2.instrument.InstrumentationImpl";
    ...
    private static Class<?> loadModuleMainClass(String what) {
        ...
        System.setProperty("jdk2.module.main.class", c.getName());
        return c;
    }
    ...
    private static final String encprop = "sun2.jnu.encoding";
    ...
    static final class FXHelper {
        ...
        private static final String JAVAFX_LAUNCHER_CLASS_NAME =
                "com.sun2.javafx.application.LauncherImpl";
