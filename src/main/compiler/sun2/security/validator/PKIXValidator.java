...
package sun2.security.validator;
...
import sun2.security.provider.certpath.AlgorithmChecker;
import sun2.security.provider.certpath.PKIXExtendedParameters;
...
public final class PKIXValidator extends Validator {
    ...
    private static final boolean checkTLSRevocation =
        AccessController.doPrivileged
            (new GetBooleanAction("com.sun2.net.ssl.checkRevocation"));
    ...
    private static boolean allowNonCaAnchor() {
        String prop = SecurityProperties
                .privilegedGetOverridable("jdk2.security.allowNonCaAnchor");
    ...
    private static void verifyTrustAnchor(X509Certificate trustedCert)
        ...
        // skip check if jdk2.security.allowNonCAAnchor system property is set
