 ...
 * jdk2.security.caDistrustPolicies security property for more information.
 */
enum CADistrustPolicy {
     ...
     * CAs, see the jdk2.security.caDistrustPolicies definition in the
    ...
    // The policies set in the jdk2.security.caDistrustPolicies property.
            ...
            new PrivilegedAction<>() {
                ...
                public String run() {
                    return Security.getProperty(
                        "jdk2.security.caDistrustPolicies");
                }
            });
            ...
            try {
                ...
                if (debug != null) {
                    debug.println("Unknown value for the " +
                                  "jdk2.security.caDistrustPolicies property: "
                                  + policy);
                }
            }
        }
