...
import java.util.*;
import javax.crypto.*;
import sun2.security.jca.ProviderList;
import sun2.security.jca.Providers;
import static sun2.security.ssl.SunJSSE.cryptoProvider;
...
final class JsseJce {
    static final boolean ALLOW_ECC =
            Utilities.getBooleanProperty("com.sun2.net.ssl.enableECC", true);
