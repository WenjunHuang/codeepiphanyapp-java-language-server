...
import sun2.security.ssl.NamedGroup.NamedGroupSpec;
import static sun2.security.ssl.SSLExtension.CH_SUPPORTED_GROUPS;
import static sun2.security.ssl.SSLExtension.EE_SUPPORTED_GROUPS;
import sun2.security.ssl.SSLExtension.ExtensionConsumer;
import sun2.security.ssl.SSLExtension.SSLExtensionSpec;
import sun2.security.ssl.SSLHandshake.HandshakeMessage;
...
final class SupportedGroupsExtension {
    ...
    static class SupportedGroups {
        ...
        static {
            ...
            //
            //      jdk2.tls.namedGroups="secp521r1, secp256r1, ffdhe2048"
            //
            // If the System Property is not defined or the value is empty, the
            // default groups and preferences will be used.
            String property = GetPropertyAction
                    .privilegedGetProperty("jdk2.tls.namedGroups");
            ...
            if (property != null && !property.isEmpty()) {
                ...
                if (groupList.isEmpty()) {
                    throw new IllegalArgumentException(
                            "System property jdk2.tls.namedGroups(" +
