...
import sun2.security.ssl.ECDHKeyExchange.ECDHEPossession;
import sun2.security.util.CurveDB;
...
enum NamedGroup {
    ...
    //
    // See sun2.security.util.CurveDB for the OIDs
    // NIST K-163
        ...
        if (mediator) {
            try {
                ...
                if (namedGroupSpec != NamedGroupSpec.NAMED_GROUP_XDH) {
                    ...
                    // AlgorithmParameters algorithms are supported in jdk2.
                    algParams = null;
                    try {
