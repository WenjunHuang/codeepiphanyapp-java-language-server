...
import sun2.security.ssl.SupportedGroupsExtension.SupportedGroups;
...
final class DHKeyExchange {
    ...
    private static final class
        ...
        static {
            ...
            if (property == null || property.isEmpty()) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException(
                        "Invalid system property jdk2.tls.ephemeralDHKeySize");
                }
            }
        }
        ...
        public SSLPossession createPossession(HandshakeContext context) {
             ...
             * mode (system property "jdk2.tls.ephemeralDHKeySize" is defined
             * as "legacy").
             *
             ...
             * "jdk2.tls.ephemeralDHKeySize" is not defined).
             *
             ...
             * "jdk2.tls.ephemeralDHKeySize" to a valid positive integer between
