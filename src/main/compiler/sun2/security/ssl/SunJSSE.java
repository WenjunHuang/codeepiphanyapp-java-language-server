...
import java.util.*;
import sun2.security.rsa.SunRsaSignEntries;
...
public abstract class SunJSSE extends java.security.Provider {
    ...
    private void doRegister(boolean isfips) {
        ...
        ps("Signature", "MD5andSHA1withRSA",
            "sun2.security.ssl.RSASignature", null, null);

        ps("KeyManagerFactory", "SunX509",
            "sun2.security.ssl.KeyManagerFactoryImpl$SunX509", null, null);
        ps("KeyManagerFactory", "NewSunX509",
            "sun2.security.ssl.KeyManagerFactoryImpl$X509",
            List.of("PKIX"), null);

        ps("TrustManagerFactory", "SunX509",
            "sun2.security.ssl.TrustManagerFactoryImpl$SimpleFactory", null, null);
        ps("TrustManagerFactory", "PKIX",
            "sun2.security.ssl.TrustManagerFactoryImpl$PKIXFactory",
           List.of("SunPKIX", "X509", "X.509"), null);

        ps("SSLContext", "TLSv1",
            "sun2.security.ssl.SSLContextImpl$TLS10Context",
            (isfips? null : List.of("SSLv3")), null);
        ps("SSLContext", "TLSv1.1",
            "sun2.security.ssl.SSLContextImpl$TLS11Context", null, null);
        ps("SSLContext", "TLSv1.2",
            "sun2.security.ssl.SSLContextImpl$TLS12Context", null, null);
        ps("SSLContext", "TLSv1.3",
            "sun2.security.ssl.SSLContextImpl$TLS13Context", null, null);
        ps("SSLContext", "TLS",
            "sun2.security.ssl.SSLContextImpl$TLSContext",
            (isfips? null : List.of("SSL")), null);

        ps("SSLContext", "DTLSv1.0",
            "sun2.security.ssl.SSLContextImpl$DTLS10Context", null, null);
        ps("SSLContext", "DTLSv1.2",
            "sun2.security.ssl.SSLContextImpl$DTLS12Context", null, null);
        ps("SSLContext", "DTLS",
            "sun2.security.ssl.SSLContextImpl$DTLSContext", null, null);

        ps("SSLContext", "Default",
            "sun2.security.ssl.SSLContextImpl$DefaultSSLContext", null, null);

        /*
         * KeyStore
         */
        ps("KeyStore", "PKCS12",
            "sun2.security.pkcs12.PKCS12KeyStore", null, null);
    }

    // com.ssl.internal.ssl.net.sun2.Provider has been deprecated since JDK 9
    @SuppressWarnings("deprecation")
    private void subclassCheck() {
        if (getClass() != com.sun2.net.ssl.internal.ssl.Provider.class) {
