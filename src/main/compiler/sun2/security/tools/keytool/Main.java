...
package sun2.security.tools.keytool;
...
import sun2.security.pkcs12.PKCS12KeyStore;
import sun2.security.provider.certpath.CertPathConstraintsParameters;
import sun2.security.util.ECKeySizeParameterSpec;
import sun2.security.util.KeyUtil;
import sun2.security.util.NamedCurve;
import sun2.security.util.ObjectIdentifier;
import sun2.security.pkcs10.PKCS10;
import sun2.security.pkcs10.PKCS10Attribute;
import sun2.security.provider.X509Factory;
import sun2.security.provider.certpath.ssl.SSLServerCertStore;
import sun2.security.util.KnownOIDs;
import sun2.security.util.Password;
import sun2.security.util.SecurityProperties;
import sun2.security.util.SecurityProviderConstants;
...
import sun2.security.pkcs.PKCS9Attribute;
import sun2.security.tools.KeyStoreUtil;
import sun2.security.tools.PathList;
import sun2.security.util.DerValue;
import sun2.security.util.Pem;
import sun2.security.validator.Validator;
import sun2.security.x509.*;

import static java.security.KeyStore.*;
import java.security.Security;
import static sun2.security.tools.keytool.Main.Command.*;
import static sun2.security.tools.keytool.Main.Option.*;
 ...
 * @see sun2.security.provider.KeyProtector
 * @see sun2.security.provider.JavaKeyStore
 *
 * @since 1.2
 */
public final class Main {
    ...
    enum Command {
        ...
        GENCRL("Generates.CRL",
            ...
            STOREPASS, STORETYPE, PROVIDERNAME, ADDPROVIDER,
            PROVIDERCLASS, PROVIDERPATH, V, PROTECTED),
        IDENTITYDB("Imports.entries.from.a.jdk2.1.1.x.style.identity.database",
    ...
    private static final java.util.ResourceBundle rb =
        java.util.ResourceBundle.getBundle(
            "sun2.security.tools.keytool.Resources");
    ...
    private void doPrintCert(final PrintStream out) throws Exception {
        if (jarfile != null) {
            // reset "jdk2.certpath.disabledAlgorithms" security property
        ...
        while (i1.hasNext() || i2.hasNext()) {
            ...
            if (ext.getClass() == Extension.class) {
                ...
                if (v.length == 0) {
                    ...
                    new sun2.security.util.HexDumpEncoder().encodeBuffer(ext.getExtensionValue(), out);
                    out.println();
                }
            }
            out.println();
    ...
    private CertificateExtensions createV3Extensions(
        ...
        // Extension object as value. This works fine inside jdk2.
        //
        ...
        try {
            ...
            if (requestedEx != null) {
                ...
                for (sun2.security.x509.Extension ex: requestedEx.getAllExtensions()) {
...
// This class is exactly the same as com.util.javac.tools.sun2.Pair,
