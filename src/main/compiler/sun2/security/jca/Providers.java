...
public class Providers {
    ...
    //
    // The code here is used by sun2.security.util.SignatureFileVerifier.
    ...
    // sun2.security.util.ManifestEntryVerifier and java.security.SecureRandom.
    public static Provider getSunProvider() {
        return new sun2.security.provider.Sun();
    }
    ...
    public static Object startJarVerification() {
        ...
        if (jarList.getProvider("SUN") == null) {
            ...
            Provider p;
            try {
                p = new sun2.security.provider.VerificationProvider();
            } catch (Exception e) {
