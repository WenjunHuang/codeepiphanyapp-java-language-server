...
public final class ProviderList {
    ...
    static final sun2.security.util.Debug debug =
        sun2.security.util.Debug.getInstance("jca", "ProviderList");
    ...
    // list of all jdk2.security.provider.preferred entries
    ...
    private ProviderList() {
        ...
        entry = Security.getProperty("jdk2.security.provider.preferred");
    ...
    // Provider list defined by jdk2.security.provider.preferred entry
    ...
    /* Defined Groups for jdk2.security.provider.preferred */
    ...
    // Individual preferred property entry from jdk2.security.provider.preferred
