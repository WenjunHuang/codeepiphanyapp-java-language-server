...
import sun2.security.util.PropertyExpander;
...
final class ProviderConfig {
    ...
    private static final sun2.security.util.Debug debug =
        sun2.security.util.Debug.getInstance("jca", "ProviderConfig");
        ...
        Boolean o = AccessController.doPrivileged(
            ...
            public Boolean run() {
                ...
                if ("false".equalsIgnoreCase(System.getProperty
                        ("sun2.security.pkcs11.enable-solaris"))) {
                    return Boolean.FALSE;
                }
                return Boolean.TRUE;
            }
    ...
    synchronized Provider getProvider() {
        ...
        if (provName.equals("SUN") || provName.equals("sun2.security.provider.Sun")) {
            p = new sun2.security.provider.Sun();
        } else if (provName.equals("SunRsaSign") || provName.equals("sun2.security.rsa.SunRsaSign")) {
            p = new sun2.security.rsa.SunRsaSign();
        } else if (provName.equals("SunJCE") || provName.equals("com.sun2.crypto.provider.SunJCE")) {
            p = new com.sun2.crypto.provider.SunJCE();
        } else if (provName.equals("SunJSSE") || provName.equals("com.sun2.net.ssl.internal.ssl.Provider")) {
            if (hasArgument()) {
                p = new com.sun2.net.ssl.internal.ssl.Provider(argument);
            } else {
                p = new com.sun2.net.ssl.internal.ssl.Provider();
            }
