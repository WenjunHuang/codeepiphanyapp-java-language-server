...
public class DSAKeyFactory extends KeyFactorySpi {
    ...
    private static final String SERIAL_PROP = "sun2.security.key.serial.interop";
    ...
    static {
         ...
         * JDK 1.4.
         *
         * If true, then we generate sun2.security.provider.DSAPublicKey.
         * If false, then we generate sun2.security.provider.DSAPublicKeyImpl.
         *
    ...
    protected Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                if (key instanceof sun2.security.provider.DSAPublicKey) {
                    return key;
                }
                // Convert key to spec
                ...
                // Check if key originates from this factory
                if (key instanceof sun2.security.provider.DSAPrivateKey) {
                    return key;
                }
                // Convert key to spec
