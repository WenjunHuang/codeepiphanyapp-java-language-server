...
import sun2.security.x509.AccessDescription;
import sun2.security.x509.AuthorityInfoAccessExtension;
import sun2.security.x509.GeneralName;
import sun2.security.x509.GeneralNameInterface;
import sun2.security.x509.PKIXExtensions;
import sun2.security.x509.URIName;
...
public final class OCSP {
    ...
    private static int initializeTimeout() {
        Integer tmp = java.security.AccessController.doPrivileged(
                new GetIntegerAction("com.sun2.security.ocsp.timeout"));
        if (tmp == null || tmp < 0) {
    ...
    // Called by com.sun2.deploy.security.TrustDecider
