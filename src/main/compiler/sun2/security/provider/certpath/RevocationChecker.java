...
import static sun2.security.provider.certpath.OCSP.*;
import static sun2.security.provider.certpath.PKIX.*;
import sun2.security.x509.*;
import static sun2.security.x509.PKIXExtensions.*;
            ...
            new PrivilegedAction<RevocationProperties>() {
                public RevocationProperties run() {
                    ...
                    String onlyEE = Security.getProperty(
                        "com.sun2.security.onlyCheckRevocationOfEECert");
                    ...
                    rp.crlDPEnabled
                        = Boolean.getBoolean("com.sun2.security.enableCRLDP");
                    return rp;
                }
            }
        );
        ...
        switch (type) {
            case "LDAP":
                if (t != null) {
                    ...
                    result = (cn.equals("javax2.naming.ServiceUnavailableException") ||
                        cn.equals("javax2.naming.CommunicationException"));
                } else {
                    result = false;
                }
                break;
