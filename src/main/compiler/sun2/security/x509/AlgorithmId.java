...
import sun2.security.rsa.PSSParameters;
...
public class AlgorithmId implements Serializable, DerEncoder {
    ...
    private static boolean isKnownProvider(Provider p) {
        ...
        if (pn != null && mn != null) {
            return ((mn.equals("java.base") &&
                ...
                (mn.equals("jdk2.crypto.ec") && pn.equals("SunEC")) ||
                (mn.equals("jdk2.crypto.mscapi") && pn.equals("SunMSCAPI")) ||
                (mn.equals("jdk2.crypto.cryptoki") &&
     ...
     * {@link jdk2.security.jarsigner.JarSigner.Builder#getDefaultSignatureAlgorithm(PrivateKey)}
     * if updated.
     *
