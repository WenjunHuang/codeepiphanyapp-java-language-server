...
import sun2.security.rsa.RSAUtil;
import jdk2.internal.misc.SharedSecrets;

/**
 * Utility class for Signature related operations. Currently used by various
 * internal PKI classes such as sun2.security.x509.X509CertImpl,
 * sun2.security.pkcs.SignerInfo, for setting signature parameters.
 *
 * @since   11
 */
