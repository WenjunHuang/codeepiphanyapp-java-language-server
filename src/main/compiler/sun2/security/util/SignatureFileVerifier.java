...
import sun2.security.pkcs.PKCS7;
import sun2.security.pkcs.SignerInfo;
...
public class SignatureFileVerifier {
         ...
         throws IOException, SignatureException
    {
        ...
        if (sfAttr != null) {
            //sun2.security.util.HexDumpEncoder hex = new sun2.security.util.HexDumpEncoder();
    ...
    private static int initializeMaxSigFileSize() {
        /*
         * System property "jdk2.jar.maxSignatureFileSize" used to configure
         * the maximum allowed number of bytes for the signature-related files
         * in a JAR file.
         */
        int tmp = GetIntegerAction.privilegedGetProperty(
                "jdk2.jar.maxSignatureFileSize", 16000000);
        if (tmp < 0 || tmp > MAX_ARRAY_SIZE) {
            if (debug != null) {
                debug.println("The default signature file size of 16000000 bytes " +
                        "will be used for the jdk2.jar.maxSignatureFileSize " +
