...
public class SecurityProperties {
    ...
    /**
     * Returns true in case the system or security property "jdk2.includeInExceptions"
     * contains the category refName
     *
     * @param refName the category to check
     * @return true in case the system or security property "jdk2.includeInExceptions"
     *         contains refName, false otherwise
     */
    public static boolean includedInExceptions(String refName) {
        String val = privilegedGetOverridable("jdk2.includeInExceptions");
        if (val == null) {
            return false;
        }
