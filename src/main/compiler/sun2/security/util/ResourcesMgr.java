...
public class ResourcesMgr {
    // intended for java.security, javax2.security and sun2.security resources
    private final static Map<String, ResourceBundle> bundles = new ConcurrentHashMap<>();

    public static String getString(String s) {
        return getBundle("sun2.security.util.Resources").getString(s);
    }

    public static String getAuthResourceString(String s) {
        return getBundle("sun2.security.util.AuthResources").getString(s);
    }
