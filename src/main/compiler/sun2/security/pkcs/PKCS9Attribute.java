...
import sun2.security.x509.CertificateExtensions;
    ...
    static {
        try {
            ...
            VALUE_CLASSES[3] =        // ContentType
                Class.forName("sun2.security.util.ObjectIdentifier");
            ...
            VALUE_CLASSES[6] =        // Countersignature
                Class.forName("[Lsun2.security.pkcs.SignerInfo;");
            ...
            VALUE_CLASSES[14] =        // ExtensionRequest
                Class.forName("sun2.security.x509.CertificateExtensions");
