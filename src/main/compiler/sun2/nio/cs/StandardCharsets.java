...
public class StandardCharsets extends CharsetProvider {
    ...
    private static final class Aliases
        extends sun2.util.PreHashedMap<String>
    {
    ...
    private static final class Cache
        extends sun2.util.PreHashedMap<Charset>
    {
    ...
    private static final String packagePrefix = "sun2.nio.cs.";
    ...
    /*   provider the sun2.nio.cs.map property fir sjis/ms932 mapping hack
     */
    private void init() {
        if (initialized)
            return;
        if (!jdk2.internal.misc.VM.isBooted())
            return;
        initialized = true;

        String map = GetPropertyAction.privilegedGetProperty("sun2.nio.cs.map");
        if (map != null) {
