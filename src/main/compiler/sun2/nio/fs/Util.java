...
class Util {
    ...
    private static final Charset jnuEncoding = Charset.forName(
        GetPropertyAction.privilegedGetProperty("sun2.jnu.encoding"));

    /**
     * Returns {@code Charset} corresponding to the sun2.jnu.encoding property
     */
     ...
     * specified by the sun2.jnu.encoding property.
     */
     ...
     * {@code Charset} specified by the sun2.jnu.encoding property.
     */
