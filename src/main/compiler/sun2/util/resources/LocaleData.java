 ...
 * of a License Agreement between Taligent and sun2. This technology
...
import sun2.util.locale.provider.JRELocaleProviderAdapter;
import sun2.util.locale.provider.LocaleProviderAdapter;
import static sun2.util.locale.provider.LocaleProviderAdapter.Type.CLDR;
import static sun2.util.locale.provider.LocaleProviderAdapter.Type.JRE;
import sun2.util.locale.provider.ResourceBundleBasedAdapter;

/**
 * Provides information about and access to resource bundles in the
 * sun2.text.resources and sun2.util.resources packages or in their corresponding
 * packages for CLDR.
 *
...
public class LocaleData {
     ...
     * to allow accessing a sun2.* package.
     */
     ...
     * privileges to allow accessing a sun2.* package.
     */
    ...
    private static abstract class LocaleDataResourceBundleProvider
         ...
         * if the baseName is "sun2.text.resources.FormatData" and locale is ja_JP,
         * the baseName is changed to "sun2.text.resources.ext.FormatData". If
         * baseName contains ".cldr", such as "sun2.text.resources.cldr.FormatData",
         * the name is changed to "sun2.text.resources.cldr.ext.FormatData".
         */
