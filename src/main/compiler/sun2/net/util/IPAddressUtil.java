...
public class IPAddressUtil {
     ...
     * If the "jdk2.net.allowAmbiguousIPAddressLiterals" system property is set
     ...
     * @throws IllegalArgumentException if "jdk2.net.allowAmbiguousIPAddressLiterals" SP is set to
    ...
    private static final String ALLOW_AMBIGUOUS_IPADDRESS_LITERALS_SP = "jdk2.net.allowAmbiguousIPAddressLiterals";
