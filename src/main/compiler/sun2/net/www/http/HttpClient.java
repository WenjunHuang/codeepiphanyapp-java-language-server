...
import sun2.net.NetworkClient;
import sun2.net.ProgressSource;
import sun2.net.www.MessageHeader;
import sun2.net.www.HeaderParser;
import sun2.net.www.MeteredStream;
import sun2.net.www.ParseUtil;
import sun2.net.www.protocol.http.AuthenticatorKeys;
import sun2.net.www.protocol.http.HttpURLConnection;
import sun2.util.logging.PlatformLogger;
import static sun2.net.www.protocol.http.HttpURLConnection.TunnelState.*;
...
public class HttpClient extends NetworkClient {
    ...
    /* "jdk2.https.negotiate.cbt" property can be set to "always" (always sent), "never" (never sent) or
    ...
    static String normalizeCBT(String s) {
        ...
        if (s.equals("always") || s.startsWith("domain:")) {
            ...
            logError("Unexpected value for \"jdk2.https.negotiate.cbt\" system property");
            return "never";
        }
    }
    ...
    static {
        ...
        String retryPost = props.getProperty("sun2.net.http.retryPost");
        String cacheNTLM = props.getProperty("jdk2.ntlm.cache");
        String cacheSPNEGO = props.getProperty("jdk2.spnego.cache");

        String s = props.getProperty("jdk2.https.negotiate.cbt");
    ...
    protected synchronized void openServer() throws IOException {
        ...
        if (url.getProtocol().equals("http") ||
            ...
            if ((proxy != null) && (proxy.type() == Proxy.Type.HTTP)) {
                sun2.net.www.URLConnection.setProxiedHost(host);
