...
package sun2.net.www.protocol.ftp;
...
public class FtpURLConnection extends URLConnection {
    ...
    public synchronized void connect() throws IOException {
        ...
        try {
            ...
            throw new sun2.net.ftp.FtpLoginException("Invalid username/password");
        }
        connected = true;
    }
