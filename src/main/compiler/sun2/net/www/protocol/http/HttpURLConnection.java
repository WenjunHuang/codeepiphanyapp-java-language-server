...
package sun2.net.www.protocol.http;
...
import jdk2.internal.misc.JavaNetHttpCookieAccess;
import jdk2.internal.misc.SharedSecrets;
import sun2.net.*;
import sun2.net.util.IPAddressUtil;
import sun2.net.www.*;
import sun2.net.www.http.HttpClient;
import sun2.net.www.http.PosterOutputStream;
import sun2.net.www.http.ChunkedInputStream;
import sun2.net.www.http.ChunkedOutputStream;
...
import static sun2.net.www.protocol.http.AuthScheme.BASIC;
import static sun2.net.www.protocol.http.AuthScheme.DIGEST;
import static sun2.net.www.protocol.http.AuthScheme.NTLM;
import static sun2.net.www.protocol.http.AuthScheme.NEGOTIATE;
import static sun2.net.www.protocol.http.AuthScheme.KERBEROS;
import static sun2.net.www.protocol.http.AuthScheme.UNKNOWN;
import sun2.security.action.GetIntegerAction;
...
public class HttpURLConnection extends java.net.HttpURLConnection {
     ...
     *
     * sun2.net.http.errorstream.enableBuffering = <boolean>
     *
    ...
    */
    ...
    static {
        ...
        String p = getNetProperty("jdk2.http.auth.tunneling.disabledSchemes");
        disabledTunnelingSchemes = schemesListToSet(p);
        p = getNetProperty("jdk2.http.auth.proxying.disabledSchemes");
        ...
        String maxHeaderSizeStr = getNetProperty("jdk2.http.maxHeaderSize");
    ...
    private static final PlatformLogger logger =
            PlatformLogger.getLogger("sun2.net.www.protocol.http.HttpURLConnection");
    ...
    private boolean checkSetHost() {
        ...
        if (s != null) {
            ...
            if (name.equals("sun.plugin2.applet.AWTAppletSecurityManager") ||
                ...
                name.equals("com.sun2.javaws.security.JavaWebStartSecurity") ||
    ...
    protected HttpURLConnection(URL u, Proxy p, Handler handler)
        ...
        instProxy = p;
        if (instProxy instanceof sun2.net.ApplicationProxy) {
    ...
    protected void plainConnect0()  throws IOException {
        ...
        try {
            ...
            if (instProxy == null) { // no instance Proxy is set
                ...
                if (sel != null) {
                    URI uri = sun2.net.www.ParseUtil.toURI(url);
                    if (logger.isLoggable(PlatformLogger.Level.FINEST)) {
