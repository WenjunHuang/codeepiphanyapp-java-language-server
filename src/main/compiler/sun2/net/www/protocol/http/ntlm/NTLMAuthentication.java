...
package sun2.net.www.protocol.http.ntlm;
...
import sun2.net.NetProperties;
import sun2.net.www.HeaderParser;
import sun2.net.www.protocol.http.AuthenticationInfo;
import sun2.net.www.protocol.http.AuthScheme;
...
public class NTLMAuthentication extends AuthenticationInfo {
    ...
    static {
        ...
        String ntlmCacheProp = props.getProperty("jdk2.ntlm.cache", "true");
        ntlmCache = Boolean.parseBoolean(ntlmCacheProp);
        String modeProp = java.security.AccessController.doPrivileged(
            new java.security.PrivilegedAction<String>() {
                public String run() {
                    return NetProperties.get("jdk2.http.ntlm.transparentAuth");
                }
            });
