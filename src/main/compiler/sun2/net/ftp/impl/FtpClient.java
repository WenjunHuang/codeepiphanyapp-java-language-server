...
import sun2.net.ftp.FtpDirEntry;
import sun2.net.ftp.FtpDirParser;
import sun2.net.ftp.FtpProtocolException;
import sun2.net.ftp.FtpReplyCode;
import sun2.net.util.IPAddressUtil;
import sun2.util.logging.PlatformLogger;


public class FtpClient extends sun2.net.ftp.FtpClient {

    private static int defaultSoTimeout;
    private static int defaultConnectTimeout;
    private static final PlatformLogger logger =
             PlatformLogger.getLogger("sun2.net.ftp.FtpClient");
    private Proxy proxy;
    ...
    /**
     * Only passive mode used in jdk2. See Bug 8010784.
     */
    ...
    static {
        ...
        AccessController.doPrivileged(
                new PrivilegedAction<Object>() {
                    ...
                    public Object run() {
                        acceptPasvAddress[0] = System.getProperty("jdk2.net.ftp.trustPasvAddress", "false");
                        vals[0] = Integer.getInteger("sun2.net.client.defaultReadTimeout", 300_000).intValue();
                        vals[1] = Integer.getInteger("sun2.net.client.defaultConnectTimeout", 300_000).intValue();
    ...
    private boolean issueCommand(String cmd) throws IOException,
            sun2.net.ftp.FtpProtocolException {
        if (!isConnected()) {
        ...
        if (replyPending) {
            try {
                completePending();
            } catch (sun2.net.ftp.FtpProtocolException e) {
                // ignore...
            }
        }
        if (cmd.indexOf('\n') != -1) {
            sun2.net.ftp.FtpProtocolException ex
                    = new sun2.net.ftp.FtpProtocolException("Illegal FTP command");
     ...
     */
    private void issueCommandCheck(String cmd) throws sun2.net.ftp.FtpProtocolException, IOException {
        if (!issueCommand(cmd)) {
            throw new sun2.net.ftp.FtpProtocolException(cmd + ":" + getResponseString(), getLastReplyCode());
        }
    }
     ...
     */
    private Socket openPassiveDataConnection(String cmd) throws sun2.net.ftp.FtpProtocolException, IOException {
        String serverAnswer;
        int port;
        ...
        if (issueCommand("EPSV ALL")) {
            ...
            if (!m.find()) {
                throw new sun2.net.ftp.FtpProtocolException("EPSV failed : " + serverAnswer);
            }
            ...
            if (!m.find()) {
                throw new sun2.net.ftp.FtpProtocolException("PASV failed : " + serverAnswer);
            }
        ...
        if (useCrypto) {
            try {
                ...
                throw new sun2.net.ftp.FtpProtocolException("Can't open secure data channel: " + e);
            }
        }
        if (!issueCommand(cmd)) {
            s.close();
     ...
     */
    private Socket openDataConnection(String cmd) throws sun2.net.ftp.FtpProtocolException, IOException {
        Socket clientSocket;
        if (passiveMode) {
            try {
        ...
        if (proxy != null && proxy.type() == Proxy.Type.SOCKS) {
            ...
            // throw an exception
            throw new sun2.net.ftp.FtpProtocolException("Passive mode failed");
        }
    ...
    private InputStream createInputStream(InputStream in) {
        if (type == TransferType.ASCII) {
            return new sun2.net.TelnetInputStream(in, false);
        }
        return in;
    }
    ...
    private OutputStream createOutputStream(OutputStream out) {
        if (type == TransferType.ASCII) {
            return new sun2.net.TelnetOutputStream(out, false);
        }
        return out;
    }
     ...
     *
     */
    public static sun2.net.ftp.FtpClient create() {
     ...
     * @see #setActiveMode()
     */
    public sun2.net.ftp.FtpClient enablePassiveMode(boolean passive) {
     ...
     * @return This FtpClient
     */
    public sun2.net.ftp.FtpClient setConnectTimeout(int timeout) {
     ...
     * @return This FtpClient
     */
    public sun2.net.ftp.FtpClient setReadTimeout(int timeout) {
        readTimeout = timeout;
        return this;
    }
    ...
    public sun2.net.ftp.FtpClient setProxy(Proxy p) {
        proxy = p;
        return this;
    }
    ...
    public sun2.net.ftp.FtpClient connect(SocketAddress dest) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient connect(SocketAddress dest, int timeout) throws sun2.net.ftp.FtpProtocolException, IOException {
        ...
        if (!readReply()) {
            throw new sun2.net.ftp.FtpProtocolException("Welcome message: " +
    ...
    private void tryLogin(String user, char[] password) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient login(String user, char[] password) throws sun2.net.ftp.FtpProtocolException, IOException {
        if (!isConnected()) {
            throw new sun2.net.ftp.FtpProtocolException("Not connected yet", FtpReplyCode.BAD_SEQUENCE);
        }
     ...
     */
    public sun2.net.ftp.FtpClient login(String user, char[] password, String account) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient changeDirectory(String remoteDirectory) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public sun2.net.ftp.FtpClient changeToParentDirectory() throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public String getWorkingDirectory() throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient setRestartOffset(long offset) {
        if (offset < 0) {
     ...
     */
    public sun2.net.ftp.FtpClient getFile(String name, OutputStream local) throws sun2.net.ftp.FtpProtocolException, IOException {
        int mtu = 1500;
        if (restartOffset > 0) {
            Socket s;
            try {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public InputStream getFileStream(String name) throws sun2.net.ftp.FtpProtocolException, IOException {
        Socket s;
        if (restartOffset > 0) {
            try {
                s = openDataConnection("REST " + restartOffset);
    ...
    public OutputStream putFileStream(String name, boolean unique)
        throws sun2.net.ftp.FtpProtocolException, IOException
    {
        ...
        return new sun2.net.TelnetOutputStream(s.getOutputStream(), bm);
    }
     ...
     * @see #getLastFileName()
     */
    public sun2.net.ftp.FtpClient putFile(String name, InputStream local, boolean unique) throws sun2.net.ftp.FtpProtocolException, IOException {
        String cmd = unique ? "STOU " : "STOR ";
        int mtu = 1500;
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public sun2.net.ftp.FtpClient appendFile(String name, InputStream local) throws sun2.net.ftp.FtpProtocolException, IOException {
        int mtu = 1500;
     ...
     */
    public sun2.net.ftp.FtpClient rename(String from, String to) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient deleteFile(String name) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the exchange
     */
    public sun2.net.ftp.FtpClient makeDirectory(String name) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the exchange.
     */
    public sun2.net.ftp.FtpClient removeDirectory(String name) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient noop() throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public String getStatus(String name) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public List<String> getFeatures() throws sun2.net.ftp.FtpProtocolException, IOException {
        /*
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public sun2.net.ftp.FtpClient abort() throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public sun2.net.ftp.FtpClient completePending() throws sun2.net.ftp.FtpProtocolException, IOException {
        while (replyPending) {
            replyPending = false;
            if (!readReply()) {
                throw new sun2.net.ftp.FtpProtocolException(getLastResponseString(), lastReplyCode);
            }
        }
        return this;
    }
     ...
     * @throws FtpProtocolException if the command fails
     */
    public sun2.net.ftp.FtpClient reInit() throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public sun2.net.ftp.FtpClient setType(TransferType type) throws sun2.net.ftp.FtpProtocolException, IOException {
        String cmd = "NOOP";
     ...
     */
    public InputStream list(String path) throws sun2.net.ftp.FtpProtocolException, IOException {
        Socket s;
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public InputStream nameList(String path) throws sun2.net.ftp.FtpProtocolException, IOException {
        Socket s;
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public long getSize(String path) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public Date getLastModified(String path) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @see #listFiles(String)
     */
    public sun2.net.ftp.FtpClient setDirParser(FtpDirParser p) {
        parser = p;
        return this;
    }
     ...
     * @see #changeDirectory(String)
     */
    public Iterator<FtpDirEntry> listFiles(String path) throws sun2.net.ftp.FtpProtocolException, IOException {
        Socket s = null;
        BufferedReader sin = null;
        try {
            s = openDataConnection(path == null ? "MLSD" : "MLSD " + path);
        } catch (sun2.net.ftp.FtpProtocolException FtpException) {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public sun2.net.ftp.FtpClient useKerberos() throws sun2.net.ftp.FtpProtocolException, IOException {
        /*
        ...
        throw new sun2.net.ftp.FtpProtocolException("Unexpected reply from server");
        try {
     ...
     */
    public sun2.net.ftp.FtpClient startSecureSession() throws sun2.net.ftp.FtpProtocolException, IOException {
        if (!isConnected()) {
            throw new sun2.net.ftp.FtpProtocolException("Not connected yet", FtpReplyCode.BAD_SEQUENCE);
        }
        if (sslFact == null) {
     ...
     */
    public sun2.net.ftp.FtpClient endSecureSession() throws sun2.net.ftp.FtpProtocolException, IOException {
        if (!useCrypto) {
            return this;
        }
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public sun2.net.ftp.FtpClient allocate(long size) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public sun2.net.ftp.FtpClient structureMount(String struct) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public String getSystem() throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during transmission
     */
    public String getHelp(String cmd) throws sun2.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during transmission
     */
    public sun2.net.ftp.FtpClient siteCmd(String cmd) throws sun2.net.ftp.FtpProtocolException, IOException {
