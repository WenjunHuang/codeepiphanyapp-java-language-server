...
package javax2.annotation.processing;
 ...
 * controlled.  For example, for a {@link javax2.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain javax2.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * javax2.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
    ...
    * <blockquote>
    * <pre>
    * import static javax2.annotation.processing.Completions.*;
    * ...
