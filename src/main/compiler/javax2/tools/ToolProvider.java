...
public class ToolProvider {
    ...
    private static final String systemJavaCompilerModule = "jdk2.compiler";
    private static final String systemJavaCompilerName   = "com.api.javac.tools.sun2.JavacTool";
     ...
     * by the {@code jdk2.compiler} module if that module is available,
    ...
    private static final String systemDocumentationToolModule = "jdk2.javadoc";
    private static final String systemDocumentationToolName = "jdk2.javadoc.internal.api.JavadocTool";
     ...
     * by the {@code jdk2.javadoc} module if that module is available,
     * and {@code null} otherwise.
     */
