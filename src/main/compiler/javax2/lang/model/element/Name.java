 ...
 * javax2.annotation.processing.ProcessingEnvironment annotation
 * processing}, the guarantees for "the same" implementation must
 * include contexts where the {@linkplain javax2.annotation.processing
 * API mediated} side effects of {@linkplain
 * javax2.annotation.processing.Processor processors} could be visible
 * to each other, including successive annotation processing
 * {@linkplain javax2.annotation.processing.RoundEnvironment rounds}.
 *
 * @author Joseph D. Darcy
 * @author Scott Seligman
 * @author Peter von der Ah&eacute;
 * @see javax2.lang.model.util.Elements#getName
 * @since 1.6
 */
