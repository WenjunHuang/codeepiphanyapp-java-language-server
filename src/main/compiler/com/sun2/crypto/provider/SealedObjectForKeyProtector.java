...
final class SealedObjectForKeyProtector extends SealedObject {
     ...
     * level filter defined by jdk2.serialFilter will be consulted. The value
     * of this property uses the same format of jdk2.serialFilter.
     */
            ...
            try {
                ...
                if (msg.contains("REJECTED")) {
                    throw new IOException("Rejected by the"
                            + " jceks.key.serialFilter or jdk2.serialFilter"
                            + " property", ice);
                } else {
                    throw ice;
                }
     ...
     * is UNDECIDED, the system level jdk2.serialFilter will be consulted.
     */
