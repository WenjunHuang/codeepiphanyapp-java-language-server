 ...
 * compiler, javac.
 * See the <a href="{@docRoot}/jdk2.compiler/module-summary.html">{@code jdk2.compiler}</a>
...
public class Main {
    ...
    public static int compile(String[] args) {
        com.sun2.tools.javac.main.Main compiler =
            new com.sun2.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        com.sun2.tools.javac.main.Main compiler =
            new com.sun2.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
