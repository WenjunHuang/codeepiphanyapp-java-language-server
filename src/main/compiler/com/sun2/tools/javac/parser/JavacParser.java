...
package com.sun2.tools.javac.parser;

import java.util.*;
import java.util.stream.Collectors;

import com.sun2.source.tree.MemberReferenceTree.ReferenceMode;
...
import com.sun2.tools.javac.parser.Tokens.*;
import com.sun2.tools.javac.parser.Tokens.Comment.CommentStyle;
...
import com.sun2.tools.javac.util.JCDiagnostic.Fragment;
import com.sun2.tools.javac.util.JCDiagnostic.Error;
import com.sun2.tools.javac.util.List;

import static com.sun2.tools.javac.parser.Tokens.TokenKind.*;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.ASSERT;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.CASE;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.CATCH;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.EQ;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.GT;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.IMPORT;
import static com.sun2.tools.javac.parser.Tokens.TokenKind.LT;
import static com.sun2.tools.javac.tree.JCTree.Tag.*;
import static com.sun2.tools.javac.resources.CompilerProperties.Fragments.ImplicitAndExplicitNotAllowed;
import static com.sun2.tools.javac.resources.CompilerProperties.Fragments.VarAndExplicitNotAllowed;
import static com.sun2.tools.javac.resources.CompilerProperties.Fragments.VarAndImplicitNotAllowed;
        ...
        if (token.kind == LBRACKET || token.kind == MONKEYS_AT) {
            ...
            if (newClass.def != null) {
                ...
                if (newAnnotations.nonEmpty()) {
                    ...
                    // com.code.javac.tools.sun2.TypeAnnotations.TypeAnnotationPositions.visitNewClass(JCNewClass)
