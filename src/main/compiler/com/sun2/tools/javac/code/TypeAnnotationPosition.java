...
*/
// Code duplicated in com.sun2.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // com.jvm.javac.tools.sun2.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // com.jvm.javac.tools.sun2.Code.fillExceptionParameterPositions we
