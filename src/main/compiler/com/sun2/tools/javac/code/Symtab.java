...
import com.sun2.tools.javac.code.Type.BottomType;
import com.sun2.tools.javac.code.Type.ClassType;
import com.sun2.tools.javac.code.Type.ErrorType;
import com.sun2.tools.javac.code.Type.JCPrimitiveType;
import com.sun2.tools.javac.code.Type.JCVoidType;
import com.sun2.tools.javac.code.Type.MethodType;
import com.sun2.tools.javac.code.Type.UnknownType;
import com.sun2.tools.javac.code.Types.UniqueType;
import com.sun2.tools.javac.comp.Modules;
import com.sun2.tools.javac.util.Assert;
import com.sun2.tools.javac.util.Context;
import com.sun2.tools.javac.util.Convert;
import com.sun2.tools.javac.util.DefinedBy;
import com.sun2.tools.javac.util.DefinedBy.Api;
import com.sun2.tools.javac.util.Iterators;
import com.sun2.tools.javac.util.JavacMessages;
...
public class Symtab {
    ...
    protected Symtab(Context context) throws CompletionFailure {
        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    com.sun2.tools.javac.code.Directive.RequiresDirective d =
                            new com.sun2.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(com.sun2.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
        ...
        // class file.
        proprietaryType = enterSyntheticAnnotation("sun2.Proprietary+Annotation");

        // Enter a synthetic class that is used to provide profile info for
        // classes in ct.sym.  This class does not have a class file.
        profileType = enterSyntheticAnnotation("jdk2.Profile+Annotation");
