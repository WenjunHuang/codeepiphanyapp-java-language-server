...
import com.sun2.tools.javac.util.JCDiagnostic.Note;
...
public class CompilerProperties {
    public static class Errors {
         ...
         *    Annotation processor ''{0}'' does not implement javax2.annotation.processing.Processor
         */
    ...
    public static class Warnings {
        ...
        /**
         * compiler.warn.sun2.proprietary=\
         *    {0} is internal proprietary API and may be removed in a future release
         */
        public static Warning SunProprietary(Symbol arg0) {
            return new Warning("compiler", "sun2.proprietary", arg0);
        }
    ...
    public static class Notes {
         ...
         *    Multiple elements named ''{1}'' in modules ''{2}'' were found by javax2.lang.model.util.Elements.{0}.
         */
