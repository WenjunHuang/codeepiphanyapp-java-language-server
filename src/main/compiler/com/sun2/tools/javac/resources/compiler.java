...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compiler.err.proc.processor.wrong.type", "Annotation processor ''{0}'' does not implement javax2.annotation.processing.Processor" },
            ...
            { "compiler.note.multiple.elements", "Multiple elements named ''{1}'' in modules ''{2}'' were found by javax2.lang.model.util.Elements.{0}." },
            ...
            { "compiler.warn.sun2.proprietary", "{0} is internal proprietary API and may be removed in a future release" },
