...
import javax2.lang.model.element.AnnotationMirror;
import javax2.lang.model.element.AnnotationValue;
...
import javax2.tools.ForwardingFileObject;
...
import com.sun2.tools.javac.code.Symbol.MethodSymbol;
import com.sun2.tools.javac.code.Symbol.ModuleSymbol;
import com.sun2.tools.javac.code.Symbol.PackageSymbol;
import com.sun2.tools.javac.code.Symbol.TypeSymbol;
import com.sun2.tools.javac.code.Symbol.VarSymbol;
import com.sun2.tools.javac.code.Symtab;
import com.sun2.tools.javac.code.Type;
import com.sun2.tools.javac.code.Type.ArrayType;
import com.sun2.tools.javac.code.Type.ClassType;
import com.sun2.tools.javac.code.Type.ErrorType;
import com.sun2.tools.javac.code.Type.UnionClassType;
import com.sun2.tools.javac.code.Types;
import com.sun2.tools.javac.code.Types.TypeRelation;
import com.sun2.tools.javac.comp.Attr;
import com.sun2.tools.javac.comp.AttrContext;
import com.sun2.tools.javac.comp.Enter;
import com.sun2.tools.javac.comp.Env;
import com.sun2.tools.javac.comp.MemberEnter;
import com.sun2.tools.javac.comp.Modules;
import com.sun2.tools.javac.comp.Resolve;
import com.sun2.tools.javac.file.BaseFileManager;
import com.sun2.tools.javac.model.JavacElements;
import com.sun2.tools.javac.parser.DocCommentParser;
import com.sun2.tools.javac.parser.ParserFactory;
import com.sun2.tools.javac.parser.Tokens.Comment;
...
import com.sun2.tools.javac.resources.CompilerProperties.Notes;
import com.sun2.tools.javac.resources.CompilerProperties.Warnings;
import com.sun2.tools.javac.tree.DCTree;
import com.sun2.tools.javac.tree.DCTree.DCBlockTag;
import com.sun2.tools.javac.tree.DCTree.DCDocComment;
import com.sun2.tools.javac.tree.DCTree.DCEndPosTree;
import com.sun2.tools.javac.tree.DCTree.DCErroneous;
import com.sun2.tools.javac.tree.DCTree.DCIdentifier;
import com.sun2.tools.javac.tree.DCTree.DCParam;
import com.sun2.tools.javac.tree.DCTree.DCReference;
import com.sun2.tools.javac.tree.DCTree.DCText;
import com.sun2.tools.javac.tree.DocCommentTable;
import com.sun2.tools.javac.tree.DocTreeMaker;
import com.sun2.tools.javac.tree.EndPosTable;
import com.sun2.tools.javac.tree.JCTree;
import com.sun2.tools.javac.tree.JCTree.JCBlock;
import com.sun2.tools.javac.tree.JCTree.JCCatch;
import com.sun2.tools.javac.tree.JCTree.JCClassDecl;
import com.sun2.tools.javac.tree.JCTree.JCCompilationUnit;
import com.sun2.tools.javac.tree.JCTree.JCExpression;
import com.sun2.tools.javac.tree.JCTree.JCIdent;
import com.sun2.tools.javac.tree.JCTree.JCMethodDecl;
import com.sun2.tools.javac.tree.JCTree.JCVariableDecl;
import com.sun2.tools.javac.tree.TreeCopier;
import com.sun2.tools.javac.tree.TreeInfo;
import com.sun2.tools.javac.tree.TreeMaker;
import com.sun2.tools.javac.util.Abort;
...
import com.sun2.tools.javac.util.DiagnosticSource;
import com.sun2.tools.javac.util.JCDiagnostic;
import com.sun2.tools.javac.util.JCDiagnostic.DiagnosticFlag;
import com.sun2.tools.javac.util.List;
import com.sun2.tools.javac.util.ListBuffer;
import com.sun2.tools.javac.util.Log;
import com.sun2.tools.javac.util.Name;
import com.sun2.tools.javac.util.Names;
import com.sun2.tools.javac.util.Pair;
import com.sun2.tools.javac.util.Position;

import static com.sun2.tools.javac.code.Kinds.Kind.*;
import static com.sun2.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    /** @see com.sun2.tools.javadoc.ClassDocImpl#findConstructor */
    ...
    /** @see com.sun2.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see com.sun2.tools.javadoc.ClassDocImpl#searchMethod */
    ...
    /** @see com.sun2.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof com.sun2.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (com.sun2.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
     ...
     */
    @Override @DefinedBy(Api.COMPILER_TREE)
    public TypeMirror getOriginalType(javax2.lang.model.type.ErrorType errorType) {
        if (errorType instanceof com.sun2.tools.javac.code.Type.ErrorType) {
            return ((com.sun2.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }
        if (errorType instanceof com.sun2.tools.javac.code.Type.ClassType &&
        ...
        return com.sun2.tools.javac.code.Type.noType;
    }
