...
/**
 * TODO: describe com.sun2.tools.javac.api.Tool
 *
...
public final class JavacTool implements JavaCompiler {
     ...
     * @see javax2.tools.JavaCompiler
     * @see javax2.tools.ToolProvider
     * @see #create
     */
    @Deprecated
    public JavacTool() {}
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        return com.sun2.tools.javac.Main.compile(arguments, new PrintWriter(err, true));
    }
