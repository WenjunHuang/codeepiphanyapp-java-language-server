...
import com.sun2.tools.javac.main.*;
import com.sun2.tools.javac.parser.Parser;
...
public class JavacTaskImpl extends BasicJavacTask {
    ...
    private <T> T handleExceptions(Callable<T> c, T sysErrorResult, T abnormalErrorResult) {
        ...
        try {
            ...
            // as specified by javax2.tools.JavaCompiler#getTask
            // and javax2.tools.JavaCompiler.CompilationTask#call
            throw new RuntimeException(e.getCause());
