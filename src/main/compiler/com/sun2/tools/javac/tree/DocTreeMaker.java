...
package com.sun2.tools.javac.tree;
...
import com.sun2.source.doctree.DocTree.Kind;
...
import com.sun2.source.util.DocTreeFactory;
import com.sun2.tools.doclint.HtmlTag;
import com.sun2.tools.javac.api.JavacTrees;
import com.sun2.tools.javac.parser.ParserFactory;
import com.sun2.tools.javac.parser.ReferenceParser;
import com.sun2.tools.javac.parser.Tokens.Comment;
import com.sun2.tools.javac.tree.DCTree.DCAttribute;
import com.sun2.tools.javac.tree.DCTree.DCAuthor;
import com.sun2.tools.javac.tree.DCTree.DCComment;
import com.sun2.tools.javac.tree.DCTree.DCDeprecated;
import com.sun2.tools.javac.tree.DCTree.DCDocComment;
import com.sun2.tools.javac.tree.DCTree.DCDocRoot;
import com.sun2.tools.javac.tree.DCTree.DCDocType;
import com.sun2.tools.javac.tree.DCTree.DCEndElement;
import com.sun2.tools.javac.tree.DCTree.DCEntity;
import com.sun2.tools.javac.tree.DCTree.DCErroneous;
import com.sun2.tools.javac.tree.DCTree.DCHidden;
import com.sun2.tools.javac.tree.DCTree.DCIdentifier;
import com.sun2.tools.javac.tree.DCTree.DCIndex;
import com.sun2.tools.javac.tree.DCTree.DCInheritDoc;
import com.sun2.tools.javac.tree.DCTree.DCLink;
import com.sun2.tools.javac.tree.DCTree.DCLiteral;
import com.sun2.tools.javac.tree.DCTree.DCParam;
import com.sun2.tools.javac.tree.DCTree.DCProvides;
import com.sun2.tools.javac.tree.DCTree.DCReference;
import com.sun2.tools.javac.tree.DCTree.DCReturn;
import com.sun2.tools.javac.tree.DCTree.DCSee;
import com.sun2.tools.javac.tree.DCTree.DCSerial;
import com.sun2.tools.javac.tree.DCTree.DCSerialData;
import com.sun2.tools.javac.tree.DCTree.DCSerialField;
import com.sun2.tools.javac.tree.DCTree.DCSince;
import com.sun2.tools.javac.tree.DCTree.DCStartElement;
import com.sun2.tools.javac.tree.DCTree.DCSummary;
import com.sun2.tools.javac.tree.DCTree.DCText;
import com.sun2.tools.javac.tree.DCTree.DCThrows;
import com.sun2.tools.javac.tree.DCTree.DCUnknownBlockTag;
import com.sun2.tools.javac.tree.DCTree.DCUnknownInlineTag;
import com.sun2.tools.javac.tree.DCTree.DCUses;
import com.sun2.tools.javac.tree.DCTree.DCValue;
import com.sun2.tools.javac.tree.DCTree.DCVersion;
...
import static com.sun2.tools.doclint.HtmlTag.*;
...
public class DocTreeMaker implements DocTreeFactory {
    ...
    @Override @DefinedBy(Api.COMPILER_TREE)
    public DCAttribute newAttributeTree(javax2.lang.model.element.Name name, ValueKind vkind, java.util.List<? extends DocTree> value) {
    ...
    private boolean isSentenceBreak(javax2.lang.model.element.Name tagName) {
