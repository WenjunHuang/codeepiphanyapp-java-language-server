...
import com.sun2.tools.javac.code.ClassFinder;
...
import com.sun2.tools.sjavac.comp.PubapiVisitor;
import com.sun2.tools.sjavac.comp.SmartFileManager;
...
public class PubApiExtractor {
    ...
    public PubApiExtractor(Options options) {
        JavacTool compiler = com.sun2.tools.javac.api.JavacTool.create();
        fileManager = new SmartFileManager(compiler.getStandardFileManager(null, null, null));
        context = new com.sun2.tools.javac.util.Context();
