...
import com.sun2.tools.javac.main.CommandLine;
import com.sun2.tools.sjavac.Transformer;

/**
 * This class is used to decode sjavac options.
 * See com.options.sjavac.tools.sun2.Options for example usage.
 *
    ...
    void traverse(String[] args) {
        ...
        while (argIter.hasNext()) {
            ...
            if (arg.startsWith("-")) {
                ...
                for (com.sun2.tools.javac.main.Option javacOpt : com.sun2.tools.javac.main.Option.values()) {
