...
import javax2.tools.ToolProvider;
...
import com.sun2.tools.javac.util.Dependencies;
import com.sun2.tools.javac.util.ListBuffer;
import com.sun2.tools.sjavac.Log;
import com.sun2.tools.sjavac.Util;
import com.sun2.tools.sjavac.comp.dependencies.NewDependencyCollector;
import com.sun2.tools.sjavac.comp.dependencies.PublicApiCollector;
import com.sun2.tools.sjavac.server.CompilationSubResult;
import com.sun2.tools.sjavac.server.SysInfo;
                ...
                if (explicitJFOs.size() > 0) {
                    ...
                    JavacTaskImpl task =
                            (JavacTaskImpl) compiler.getTask(new PrintWriter(stderrLog),
                                                             ...
                                                             explicitJFOs,
                                                             context);
                    sfm.setSymbolFileEnabled(!com.sun2.tools.javac.util.Options.instance(context).isSet("ignore.symbol.file"));
