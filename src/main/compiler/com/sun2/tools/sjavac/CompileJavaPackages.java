...
import com.sun2.tools.sjavac.comp.CompilationService;
...
public class CompileJavaPackages implements Transformer {
    ...
    public boolean transform(final CompilationService sjavac,
        ...
        // in the Openjdk2. This will change in the future.
        ...
        // Number experimentally determined when compiling the Openjdk2.
        ...
        String dataModel = System.getProperty("sun2.arch.data.model");
