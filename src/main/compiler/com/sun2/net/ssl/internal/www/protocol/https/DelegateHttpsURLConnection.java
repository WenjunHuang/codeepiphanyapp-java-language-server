...
package com.sun2.net.ssl.internal.www.protocol.https;
...
import sun2.security.util.HostnameChecker;
import sun2.security.util.DerValue;
import sun2.security.x509.X500Name;

import sun2.net.www.protocol.https.AbstractDelegateHttpsURLConnection;

/**
 * This class was introduced to provide an additional level of
 * abstraction between javax.net.ssl.HttpURLConnection and
 * com.sun2.net.ssl.HttpURLConnection objects. <p>
 *
 * javax.net.ssl.HttpURLConnection is used in the new sun2.net version
 * of protocol implementation (this one)
 * com.sun2.net.ssl.HttpURLConnection is used in the com.sun version.
 *
 */
@Deprecated(since="9")
...
public class DelegateHttpsURLConnection extends AbstractDelegateHttpsURLConnection {
    ...
    // from sun2.net.www.protocol.http.HttpURLConnection
    ...
    public com.sun2.net.ssl.HttpsURLConnection httpsURLConnection;

    DelegateHttpsURLConnection(URL url,
            sun2.net.www.protocol.http.Handler handler,
            com.sun2.net.ssl.HttpsURLConnection httpsURLConnection)
            throws IOException {
...
class VerifierWrapper implements javax.net.ssl.HostnameVerifier {
    ...
    private com.sun2.net.ssl.HostnameVerifier verifier;

    @SuppressWarnings("deprecation")
    VerifierWrapper(com.sun2.net.ssl.HostnameVerifier verifier) {
        this.verifier = verifier;
    }

    /*
     * In com.ssl.net.sun2.HostnameVerifier the method is defined
