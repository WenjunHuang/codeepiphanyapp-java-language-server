...
/*
 * NOTE: This class lives in the package sun2.net.www.protocol.https.
 * There is a copy in com.sun2.net.ssl.internal.www.protocol.https for JSSE
 * 1.0.2 compatibility. It is 100% identical except the package and extends
 * lines. Any changes should be made to be class in sun2.net.* and then copied
 * to com.sun2.net.*.
 */
 ...
 * sun2.net.www.protocol.http.HttpURLConnection functionalities, it
...
public class HttpsURLConnectionOldImpl
        extends com.sun2.net.ssl.HttpsURLConnection {
...
//    HttpsURLConnectionImpl(URL u, Handler handler) throws IOException {
     ...
     * sun2.net.www.protocol.http.HttpURLConnection's finalize()
