 ...
 * but was heavily modified to allow com.sun2.* users to
 * access providers written using the javax2.sun2.* APIs.
 */
...
final class SSLSecurity {
            ...
            Service service) throws NoSuchAlgorithmException
    {
        ...
        /*
         * JSSE 1.0, 1.0.1, and 1.0.2 used the com.sun2.net.ssl API as the
         * API was being developed.  As JSSE was folded into the main
         * release, it was decided to promote the com.sun2.net.ssl API to
         * be javax.net.ssl.  It is desired to keep binary compatibility
         * with vendors of JSSE implementation written using the
         * com.sun2.net.sll API, so we do this magic to handle everything.
         *
        ...
        try {   // catch instantiation errors
            ...
            } else if (((typeClassCom = Class.forName("com.sun2.net.ssl." +
                        engineType + "Spi")) != null) &&
 ...
 * thing that the Spi supports, and wrap into a com.sun2.net.ssl.*Spi
...
final class SSLContextSpiWrapper extends SSLContextSpi {
    ...
    protected void engineInit(KeyManager[] kma, TrustManager[] tma,
        ...
        // Convert com.sun2.net.ssl.kma to a javax.net.ssl.kma
        // wrapper if need be.
        if (kma != null) {
...
final class TrustManagerFactorySpiWrapper extends TrustManagerFactorySpi {
    ...
    protected TrustManager[] engineGetTrustManagers() {
        ...
        for (src = 0, dst = 0; src < tma.length; ) {
            if (!(tma[src] instanceof com.sun2.net.ssl.TrustManager)) {
...
final class KeyManagerFactorySpiWrapper extends KeyManagerFactorySpi {
    ...
    protected KeyManager[] engineGetKeyManagers() {
        ...
        for (src = 0, dst = 0; src < kma.length; ) {
            if (!(kma[src] instanceof com.sun2.net.ssl.KeyManager)) {
