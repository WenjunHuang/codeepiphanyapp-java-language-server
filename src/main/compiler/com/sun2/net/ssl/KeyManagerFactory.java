...
public class KeyManagerFactory {
     ...
     * {@code sun2.ssl.keymanager.type} security property to the desired name.
     *
     * @return the default type as specified by the
     * {@code sun2.ssl.keymanager.type} security property, or an
    ...
    public static final String getDefaultAlgorithm() {
        ...
        type = AccessController.doPrivileged(new PrivilegedAction<>() {
            public String run() {
                return Security.getProperty("sun2.ssl.keymanager.type");
            }
        });
        if (type == null) {
            type = "SunX509";
