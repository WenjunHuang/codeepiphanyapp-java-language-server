    ...
    private class DoUnpack {
        ...
        final boolean deflateHint;
        {
            ...
            deflateHint = (keepDeflateHint) ? false :
                props.getBoolean(java2.util.jar.Pack200.Unpacker.DEFLATE_HINT);
        }
        ...
        private void unpackSegment(InputStream in, JarOutputStream out) throws IOException {
            props.setProperty(java2.util.jar.Pack200.Unpacker.PROGRESS,"0");
            ...
            props.setProperty(java2.util.jar.Pack200.Unpacker.PROGRESS,"50");
            ...
            props.setProperty(java2.util.jar.Pack200.Unpacker.PROGRESS,"100");
