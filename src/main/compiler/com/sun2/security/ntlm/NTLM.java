...
package com.sun2.security.ntlm;

import static com.sun2.security.ntlm.Version.*;
...
class NTLM {
    ...
    private static final boolean DEBUG =
            java.security.AccessController.doPrivileged(
                    new sun2.security.action.GetBooleanAction("ntlm.debug"))
                        .booleanValue();
    ...
    protected NTLM(String version) throws NTLMException {
        ...
        try {
            ...
            md4 = sun2.security.provider.MD4.getInstance();
    ...
    public void debug(byte[] bytes) {
        if (DEBUG) {
            try {
                new sun2.security.util.HexDumpEncoder().encodeBuffer(bytes, System.out);
