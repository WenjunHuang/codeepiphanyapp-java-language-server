...
import javax2.lang.model.type.ErrorType;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("com.sun2.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("com.sun2.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("com.sun2.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("com.sun2.tools.javac.api.JavacTrees", false, cl);
    ...
    /**
      ...
      * @return javax2.lang.model.type.TypeMirror corresponding to the original type, replaced by the ErrorType.
      */
