 ...
 * @since    1.4.2
 * @see      #getPerf
 * @see      jdk2.internal.perf.Perf.GetPerfAction
...
public final class Perf {
     ...
     * <em>"sun2.misc.Perf.getPerf"</em> <code>RuntimePermission</code>
     * permission in order to successfully acquire the singleton Perf instance.
     * <p>
     * Please note that the <em>"sun2.misc.Perf.getPerf"</em> permission
     ...
     * of <em>"sun2.misc.Perf.getPerf"</em>. A security exception will result
     ...
     *         to the <em>"jdk2.internal.perf.Perf.getPerf""</em> target.
     * @see  java.lang.RuntimePermission
     * @see  #attach
     */
    public static Perf getPerf()
    {
        ...
        if (security != null) {
            Permission perm = new RuntimePermission("jdk2.internal.perf.Perf.getPerf");
     ...
     *
     * see sun2.misc.perf.Variability
     * see sun2.misc.perf.Units
     * @see java.nio.ByteBuffer
     */
