...
public class PerfCounter {
    ...
    static class CoreCounters {
        static final PerfCounter pdt   = newPerfCounter("sun2.classloader.parentDelegationTime");
        static final PerfCounter lc    = newPerfCounter("sun2.classloader.findClasses");
        static final PerfCounter lct   = newPerfCounter("sun2.classloader.findClassTime");
        static final PerfCounter rcbt  = newPerfCounter("sun2.urlClassLoader.readClassBytesTime");
        static final PerfCounter zfc   = newPerfCounter("sun2.zip.zipFiles");
        static final PerfCounter zfot  = newPerfCounter("sun2.zip.zipFile.openTime");
    }
