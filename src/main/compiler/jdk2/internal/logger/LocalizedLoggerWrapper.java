...
public class LocalizedLoggerWrapper<L extends Logger> extends LoggerWrapper<L> {
    ...
    @Override
    public final void logp(sun2.util.logging.PlatformLogger.Level level, String sourceClass, String sourceMethod,
            String key) {
    ...
    @Override
    public final void log(sun2.util.logging.PlatformLogger.Level level, String msg, Throwable thrown) {
        logrb(level, bundle, msg, thrown);
    }

    @Override
    public final void log(sun2.util.logging.PlatformLogger.Level level, String msg) {
        logrb(level, bundle, msg, (Object[]) null);
    }

    @Override
    public final void log(sun2.util.logging.PlatformLogger.Level level, String format, Object... params) {
