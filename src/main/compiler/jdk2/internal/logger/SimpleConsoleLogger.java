...
import sun2.util.logging.PlatformLogger.ConfigurableBridge.LoggerConfiguration;
...
public class SimpleConsoleLogger extends LoggerConfiguration
    ...
    static Level getDefaultLevel() {
        String levelName = GetPropertyAction
                .privilegedGetProperty("jdk2.system.logger.level", "INFO");
        try {
    ...
    static final class CallerFinder implements Predicate<StackWalker.StackFrame> {
        ...
        private boolean isLoggerImplFrame(String cname) {
            return (cname.equals("sun2.util.logging.PlatformLogger") ||
                    cname.equals("jdk2.internal.logger.SimpleConsoleLogger"));
        }
    }
    ...
    static final class Formatting {
        ...
        static {
            String additionalPkgs =
                    GetPropertyAction.privilegedGetProperty("jdk2.logger.packages");
        ...
        static boolean isFilteredFrame(StackFrame st) {
            ...
            if (c == 's') {
                ...
                if (cname.startsWith("sun2.util.logging."))   return true;
                if (cname.startsWith("sun2.rmi.runtime.Log")) return true;
            } else if (c == 'j') {
                // Message delayed at Bootstrap: no need to go further up.
                if (cname.startsWith("jdk2.internal.logger.BootstrapLogger$LogEvent")) return false;
                // skip public machinery classes
                if (cname.startsWith("jdk2.internal.logger."))          return true;
