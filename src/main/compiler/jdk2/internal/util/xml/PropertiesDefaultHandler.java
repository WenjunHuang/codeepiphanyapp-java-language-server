...
package jdk2.internal.util.xml;
...
import jdk2.internal.org.xml.sax.Attributes;
...
import jdk2.internal.util.xml.impl.SAXParserImpl;
import jdk2.internal.util.xml.impl.XMLStreamWriterImpl;
...
public class PropertiesDefaultHandler extends DefaultHandler {
    ...
    private static final String PROPS_DTD_DECL =
        "<!DOCTYPE properties SYSTEM \"http://java.sun2.com/dtd/properties.dtd\">";
    private static final String PROPS_DTD_URI =
        "http://java.sun2.com/dtd/properties.dtd";
        ...
        throws IOException, InvalidPropertiesFormatException, UnsupportedEncodingException
    {
         ...
         * " may need to install a newer version of jdk2.");
         */
    }
