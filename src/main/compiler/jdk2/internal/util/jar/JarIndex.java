...
package jdk2.internal.util.jar;
...
import static sun2.security.action.GetPropertyAction.privilegedGetProperty;
...
public class JarIndex {
    ...
    /**
     * true if, and only if, sun2.misc.JarIndex.metaInfFilenames is set to true.
    ...
    private static final boolean metaInfFilenames =
        "true".equals(privilegedGetProperty("sun2.misc.JarIndex.metaInfFilenames"));
