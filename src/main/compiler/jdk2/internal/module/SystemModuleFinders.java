...
import jdk2.internal.jimage.ImageLocation;
import jdk2.internal.jimage.ImageReader;
import jdk2.internal.jimage.ImageReaderFactory;
import jdk2.internal.misc.JavaNetUriAccess;
import jdk2.internal.misc.SharedSecrets;
import jdk2.internal.util.StaticProperty;
import jdk2.internal.module.ModuleHashes.HashSupplier;
...
public final class SystemModuleFinders {
    ...
    static {
        String value = System.getProperty("jdk2.system.module.finder.disableFastPath");
        if (value == null) {
            USE_FAST_PATH = true;
        } else {
