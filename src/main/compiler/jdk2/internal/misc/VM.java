...
public class VM {
    ...
    public static void saveAndRemoveProperties(Properties props) {
        ...
        // from the system property sun2.nio.MaxDirectMemorySize set by the VM.
        // The system property will be removed.
        String s = (String)props.remove("sun2.nio.MaxDirectMemorySize");
        if (s != null) {
            if (s.equals("-1")) {
        ...
        s = (String)props.remove("sun2.nio.PageAlignDirectMemory");
        if ("true".equals(s))
        ...
        // used by sun2.launcher.LauncherHelper
        props.remove("sun2.java.launcher.diag");

        // used by jdk2.internal.loader.ClassLoaders
        props.remove("jdk2.boot.class.path.append");
    }
