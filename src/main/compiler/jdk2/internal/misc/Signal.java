...
public final class Signal {
     ...
     * @see jdk2.internal.misc.Signal#Signal(String name)
     */
     ...
     * @see jdk2.internal.misc.Signal#getName()
     */
     ...
     * @see jdk2.internal.misc.Signal#raise(Signal sig)
     * @see jdk2.internal.misc.Signal.Handler
     * @see jdk2.internal.misc.Signal.Handler#SIG_DFL
     * @see jdk2.internal.misc.Signal.Handler#SIG_IGN
     */
     ...
     *
     * @param sig a signal
     * @see jdk2.internal.misc.Signal#handle(Signal sig, Signal.Handler handler)
     */
