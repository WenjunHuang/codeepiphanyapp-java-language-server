...
import sun2.reflect.misc.ReflectUtil;
...
/** <P> The master factory for all reflective objects, both those in
    ...
    {@link jdk2.internal.misc.Unsafe}. </P>
*/
...
public class ReflectionFactory {
    ...
    private static void checkInitted() {
        ...
        String val = props.getProperty("sun2.reflect.noInflation");
        if (val != null && val.equals("true")) {
            noInflation = true;
        }

        val = props.getProperty("sun2.reflect.inflationThreshold");
        if (val != null) {
            try {
                inflationThreshold = Integer.parseInt(val);
            } catch (NumberFormatException e) {
                throw new RuntimeException("Unable to parse property sun2.reflect.inflationThreshold", e);
            }
        }

        disableSerialConstructorChecks =
            "true".equals(props.getProperty("jdk2.disableSerialConstructorChecks"));
