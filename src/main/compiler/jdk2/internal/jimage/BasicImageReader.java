...
import jdk2.internal.jimage.decompressor.Decompressor;
...
public class BasicImageReader implements AutoCloseable {
    ...
    static private final boolean IS_64_BIT =
            isSystemProperty("sun2.arch.data.model", "64", "32");
    static private final boolean USE_JVM_MAP =
            isSystemProperty("jdk2.image.use.jvm.map", "true", "true");
    static private final boolean MAP_ALL =
            isSystemProperty("jdk2.image.map.all", "true", IS_64_BIT ? "true" : "false");
                    ...
                    if (BasicImageReader.class.getClassLoader() == null) {
                        try {
                            Class<?> fileChannelImpl =
                                Class.forName("sun2.nio.ch.FileChannelImpl");
    ...
    public synchronized ImageLocation findLocation(String module, String name) {
        ...
        // jdk2.tools.jlink.internal.PerfectHashBuilder.
